...
class Email {
    ...
    public function enviarConfirmacion() {
        ...
        $mail->setFrom('cuentas@escomtask.com');
        $mail->addAddress('cuentas@escomtask.com', 'escomtask.com');
        ...
        $contenido = '<html>';
        $contenido .= "<p><strong>Hola " . $this->nombre . "</strong> Has Creado tu cuenta en ESCOMTask, solo debes confirmarla en el siguiente enlace</p>";
